...
Also an interesting note: riders like Mike Alessi or Vince Friese, who are consistently good starters but invariably get shuffled back down the order, will have a tendency to potentially throw off correlations a little. This will not be present (most of the time) when you restrict the dataset to only the podium finishing positions of the 450 class. Perhaps we can call this the "Mike Alessi Effect." It's not really an issue with this dataset from the years 2018-2024, but something conceptual to think about.
